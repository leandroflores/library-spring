...
import com.example.library.core.use_cases.loans.implementations.GetLoansUseCaseImplementation;
...
@DataJpaTest
public class GetLoansUseCaseTest {
    ...
    public void setUp() {
        ...
        useCase = new GetLoansUseCaseImplementation(gateway);
    }
    ...
    public void testExecute() {
        ...
        List<Loan> loans = useCase.execute();
