...
import com.example.library.core.use_cases.loans.implementations.FinalizeLoanUseCaseImplementation;
...
@DataJpaTest
public class FinalizeLoanUseCaseTest {
    ...
    public void setUp() {
        ...
        useCase = new FinalizeLoanUseCaseImplementation(gateway);
    }
    ...
    public void testExecute() {
        ...
        Loan finalizedLoan = useCase.execute(mapper.toLoan(loan));

        assert finalizedLoan.getStatus().equals(LoanStatus.COMPLETED);
        assert finalizedLoan.getLoanDate().equals(loan.getLoanDate());
        assert finalizedLoan.getBook().getTitle().equals(book.getTitle());
        assert finalizedLoan.getUser().getEmail().equals(user.getEmail());
    }
}
